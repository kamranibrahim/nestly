...
| # | File | Feature |
|---|------|---------|
| 1 | `01-home.png` | Family home / today briefing |
| 2 | `02-calendar.png` | Shared family calendar |
| 3 | `03-tasks.png` | Shared chores |
...
```bash
python3 store/screenshots/compose_appstore.py
```
