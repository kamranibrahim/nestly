          ...
          const NestCard(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text(
                  'Document scan sends the photo or PDF you choose to Nestly’s '
                  'AI endpoint so we can draft an event, expense, or task. '
                  'You review before anything is saved. Nestly stays free — '
                  'there is no paywall for core family features.',
                  style: TextStyle(
                    color: AppColors.inkSecondary,
                    height: 1.45,
                  ),
